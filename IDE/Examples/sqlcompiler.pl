...
%    of the form var(VarId), and TokenizedTerm is bound to the same term var(VarId). 
%
...
translate_arithmetic_function(var(VarId),Expression,ArithComparison,Dict,Dict):-
   ...
   not (atom_string(PrevRangeVar,"is")),

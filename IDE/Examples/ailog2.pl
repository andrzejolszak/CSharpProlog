...
% Copyright (C) 1997-2012, David Poole.
...
help_message(['AILog Version ',V,' Help',
...
'cd ''directory''.       changes directory (folder) for loads']) :-   ailog_version(V,_).

help_message(prob,[
'AILog Version ',V,' Probabilistic Reasoning Help',
'This help is for probabilistic reasoning in Ailog. This is not usefu lif you are a beginner interested in deductive reasoning.',
'AILog implements a version of the independent choice logic that allows for probabilities on atoms. These atoms should not be the head of clauses.',
...
'prob_threshold.        get the current probability threshold']) :-   ailog_version(V,_).

help_message(abduction,[
'AILog Version ',V,' Abductive Reasoning Help',
'This help is for abductive reasoning in AILog. This is not useful if you are a beginner interested in deductive reasoning.',
'Abduction allows the system to make assumptions to prove a goal, aslong as the assumptions are consistent.',
' The atoms that can be assumed are called assumables.',
' You use "false" at the head of a clause to make constraints.',
' After adding assumables or more clauses, you need to create nogoods to make sure that inconsistent sets of assumables are found.',
' Abduction in AILog does not work satisfactorily with negation as failure.',
...
start :-
   ailog_version(V,Y),
   write_all([nl,
     'AILog Version ',V,'. Copyright ',Y,', David Poole.',nl,

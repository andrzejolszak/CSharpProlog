    ...
    public class AutocompleteListView : UserControl, IAutocompleteListView
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            for (int i = startI; i < finishI; i++)
            {
                ...
                Rectangle textRect = new Rectangle(LeftPadding, y, ClientSize.Width - 1 - LeftPadding, ItemHeight - 1);
                if (rtl)
                {
                ...
                if (i == SelectedItemIndex)
                {
                    ...
                    using (Pen pen = new Pen(Colors.SelectedBackColor2))
                    {
                ...
                {
                    using (Pen pen = new Pen(Colors.HighlightingColor))
                    {
                        e.Graphics.DrawRectangle(pen, textRect);
                    }
                }
        ...
        {
            AutocompleteMenuHost host = Parent as AutocompleteMenuHost;
            if (host != null)
            {
